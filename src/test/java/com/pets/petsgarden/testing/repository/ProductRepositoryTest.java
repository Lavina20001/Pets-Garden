package com.pets.petsgarden.testing.repository;
...
public class ProductRepositoryTest {
    ...
    public void setup() {
        ...
        product.setDescription("High quality dog food");
    ...
    public void testSaveProduct_Successful() {
        ...
        assertEquals("Dog Food", savedProduct.getProductName());
    }
    ...
    public void testUpdateProduct_Successful() {
        ...
        existingProduct.setProductName("Premium Cat Food");

        when(productRepository.save(existingProduct)).thenReturn(existingProduct);

        Product updatedProduct = productRepository.save(existingProduct);
        assertNotNull(updatedProduct);
        assertEquals("Premium Cat Food", updatedProduct.getProductName());
    }
